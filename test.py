...
from ollama._types import Message  # Import the required Ollama types
...
def ollama_streamed(user_input, system_message, conversation_history, bot_name, ollama_client):
    """
    ...
    response_content = ollama_client.generate(  # Adjust this line based on Ollama API usage
    ...
    full_response = ""
    with open(chat_log_filename, "a", encoding="utf-8") as log_file:  # Open the log file in append mode
        for line in lines:
...
def user_chatbot_conversation():
    ...
    while True:
        ...
        chatbot_response = ollama_streamed(user_input, system_message, conversation_history, "Chatbot", ollama_client)
